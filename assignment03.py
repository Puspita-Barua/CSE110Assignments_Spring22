...
Original file is located at
    https://colab.research.google.com/drive/1Bn1Fco4W9H4KMTq5VqOPLoorxZTF2tRa
...
index = int(input())
start = 0
while start in range(0,index):
  start = start + 1

print(u_input[index::-1]+u_input[index+1::1])
...
lenght = len(word)
if lenght<4:
  if word[lenght-2:lenght] == "er":
    print(word[0:lenght-2] + 'est')
  else:
    print(word)
elif lenght>3:
  if word[lenght-2:lenght] != "er" and word[lenght-3:lenght] != "est":
    print(word + 'er')
  elif word[lenght-2:lenght] == "er":
    print(word[0:lenght-2] + 'est')
  elif word[lenght-3:lenght] == "est":
    print(word)
...
index = 0
while index<lenght:
  print(user[index],":",ord(user[index]))
  index = index + 1
...
user = input("Please enter in small letters: ")
lenght = len(user)
for index in range(0,lenght):
  if user[index] == "z":
    print("a",end = "")
  else:
    variable = ord(user[index])+1
    char = chr(variable)
    print(char, end = "")
...
lenght_2 = len(string_2)
if lenght_1==lenght_2:
  for char in range(lenght_1 and lenght_2):
    add=add+string_1[char]+string_2[char]
    new=add
elif lenght_1>lenght_2:
  for char in range(lenght_2):
    add=add+string_1[char]+string_2[char]
    new=add+(string_1[lenght_2:])
else:
   for char in range(lenght_1):
     add=add+string_1[char]+string_2[char]
     new=add+(string_2[lenght_1:])
...
if num%2 == 0:
  num_1 = num_1 + num*2
  for outer in range(0,num_1):
    for inner in range(0,lenght):
       add = add + string[inner]
  print(add)
else:
  num_1 = num_1 + num*3
  for outer in range(0,num_1):
